  ...
  return (
    <nav className="space-x-3  flex overflow-x-scroll no-scrollbar py-4 px-2 border-b border-gray-300 sm:justify-center">
      {categorias.map((categoria) => (
        <Button
          key={categoria}
          className={`p-4.5 sm:rounded-2xl sm:text-[16px] sm:p-6 sm:font-bold ${categoriaSelecionada === categoria ? "bg-primary/70 text-white scale-[1.05]" : "bg-primary hover:bg-primary/90"}`}
